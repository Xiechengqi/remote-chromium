#!/usr/bin/env bash
# ============================================================================
# Antigravity IDE - KasmVNC (Web 端口 7800)
# ============================================================================
...
DISPLAY="${IDE_DISPLAY:-:11}"
WEB_PORT="${IDE_NOVNC_PORT:-7800}"
VIEW_ONLY="${NOVNC_VIEW_ONLY:-false}"

KASMVNC_USER="user"
KASMVNC_PASSWORD="${IDE_NOVNC_PASSWORD:-}"
...
then
  ...
  YELLOW "IDE_NOVNC_PASSWORD is empty; defaulting KasmVNC password to '${KASMVNC_PASSWORD}'"
fi
